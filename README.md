...
<table border="0" width="100%">
  <tr>
    ...
    <td width="35%" valign="top">
      ...
      <a href="#"><img src="https://img.shields.io/badge/Minecraft-000000?style=flat-square&logo=minecraft&logoColor=white" /></a>
    </td>

    <!-- KOLOM KANAN (ACTIVITY & PROJECTS) -->
    <td width="65%" valign="top">
      ...
      <!-- WIDGET SPOTIFY REAL-TIME -->
      <!-- Ganti YOUR_SPOTIFY_UID dengan ID Spotify lo -->
      ...
      <h3>💬 In Voice</h3>
      <!-- WIDGET DISCORD LANYARD -->
      <!-- Ganti YOUR_DISCORD_ID dengan ID Discord lo -->
